...
function Questions() {
  ...
  const handleDown = (e) => {
    ...
    if (Faqs.id == "faqs-1") {
      let faqs = e.currentTarget
      IsFaqsOne ? faqs.className = "cursor-pointer rounded-md w-11/12 mx-auto flex flex-col items-center overflow-y-hidden bg-dark h-48" : faqs.className = 'cursor-pointer rounded-md w-11/12 mx-auto flex flex-col items-center justify-between overflow-y-hidden bg-dark h-12'
      IsFaqsOne ? setIsFaqsOne(false) : setIsFaqsOne(true)
    }
    if (Faqs.id == "faqs-2") {
      let faqs = e.currentTarget
      IsFaqsTwo ? faqs.className = "cursor-pointer rounded-md w-11/12 mx-auto flex flex-col items-center justify-between overflow-y-hidden bg-dark h-48" : faqs.className = 'cursor-pointer rounded-md w-11/12 mx-auto flex flex-col items-center justify-between overflow-y-hidden bg-dark h-12 '
      IsFaqsTwo ? setIsFaqsTwo(false) : setIsFaqsTwo(true)
    }
    if (Faqs.id == "faqs-3") {
      let faqs = e.currentTarget
      IsFaqsThree ? faqs.className = "cursor-pointer rounded-md w-11/12 mx-auto flex flex-col items-center justify-between overflow-y-hidden bg-dark h-48" : faqs.className = 'cursor-pointer rounded-md w-11/12 mx-auto flex flex-col items-center justify-between overflow-y-hidden bg-dark h-12 '
  ...
  return (
    <article className='min-h-screen flex mx-auto justify-center bg-black'>
      <section className='w-[59rem] mx-auto'>
        ...
        <section className=' h-4/5 flex flex-col  gap-3 ' >
          <section id='faqs-1' onClick={(e) => handleDown(e)} className='cursor-pointer rounded-md w-11/12 mx-auto flex flex-col items-center justify-between overflow-y-hidden bg-dark h-11' >
          ...
          <section id='faqs-2' onClick={(e) => handleDown(e)} className='cursor-pointer rounded-md w-11/12 mx-auto flex flex-col items-center justify-between overflow-y-hidden bg-dark h-11 ' >
          ...
          <section id='faqs-3' onClick={(e) => handleDown(e)} className='cursor-pointer rounded-md w-11/12 mx-auto flex flex-col items-center justify-between overflow-y-hidden bg-dark h-11 ' >
