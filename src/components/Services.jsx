...
function Services() {
  return (
    <section className="bg-dark py-[4rem] w-max-7xl mx-auto">
      <section className="container mx-auto grid grid-cols-2 md:grid-cols-4 place-items-center justify-between space-y-[2rem] lg:space-y-0 px-4 lg:px-8 text-white">
