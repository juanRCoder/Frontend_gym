  ...
  return (
    <>
      ...
      <div className='flex flex-col w-max-[937px] mx-auto lg:flex-row bg-black justify-center gap-x-[10rem] lg:space-x-[2rem] space-y-8 lg:space-y-0 p-8 lg:p-8'>
        ...
        <img className="mx-auto md: w-[30rem] lg:w-[28rem] object-contain mt-2 lg:mt-[3rem] mb-2 lg:mb-[5rem] transform scale-90 lg:scale-90 opacity-60 transition duration-300 hover:opacity-100 hover:rotate-3 hover:scale-75" src={Trainer}/>
      </div>
    </>
  );
}
